// This file contains the task: test_multiple_leftshift.
// This task is used to simulate the following sequence:
//

task test_multiple_leftshift;
`include "../../calc_tb/global_defines.v"
begin
    $display("Executing test sequence: test_multiple_leftshift.");
    ...
    repeat(2) @(negedge clk_i);
    $display("Execution of test sequence: test_multiple_leftshift is complete.");
end
endtask
