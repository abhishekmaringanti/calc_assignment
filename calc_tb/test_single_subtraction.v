// This file contains the task: test_single_subtraction.
// This task is used to simulate the following sequence:
//

task test_single_subtraction;
`include "../../calc_tb/global_defines.v"
begin
    $display("Executing test sequence: test_single_subtraction.");
    ...
    repeat(2) @(negedge clk_i);
    $display("Execution of test sequence: test_single_subtraction is complete.");
end
endtask
