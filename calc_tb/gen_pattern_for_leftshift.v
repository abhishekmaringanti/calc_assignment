// This file contains the declaration for the task: gen_pattern_for_leftshift

// Task to generate the input command and data:
task gen_pattern_for_leftshift;
...
`include "../../calc_tb/global_defines.v"
    ...
    begin
        $display("Entering task: gen_pattern_for_leftshift for PORT%d.", port_number);
    ...
    $display("Exiting task: gen_pattern_for_leftshift for PORT%d.", port_number);
    end
