// This file contains the task: test_multiple_rand__leftshift.
// This task is used to simulate the following sequence:
//

task test_multiple_rand__leftshift;
`include "../../calc_tb/global_defines.v"
begin
    $display("Executing test sequence: test_multiple_rand__leftshift.");
    ...
    repeat(2) @(negedge clk_i);
    $display("Execution of test sequence: test_multiple_rand__leftshift is complete.");
end
endtask
