// This file contains the declaration for the task:
// gen_pattern_for_subtraction

// Task to generate the input command and data 
task gen_pattern_for_subtraction;
    ...
    input overflow_en_dis;              // 0 - Disable underflow (underflow will never occur), 1 - Enable underflow (underflow may occur depending on inputs) 
...
`include "../../calc_tb/global_defines.v"
    ...
    begin
        $display("Entering task: gen_pattern_for_subtraction for PORT%d.", port_number);
    ...
    $display("Exiting task: gen_pattern_for_subtraction for PORT%d.", port_number);
    end
